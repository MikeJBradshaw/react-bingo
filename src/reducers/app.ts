...
const CARD_OPTIONS = [
    ...
    'Billy: Studders',
    'Billy: Hot mic',
    'Brand: Ryan is on vacation',
    'Brand: Shitting on Linux',
    'Brand: Good job ______',
    'Dirk: Need to reboot',
    'Dirk: No sound',
    'Dirk: Windows crash',
    'Eric: No sound',
    'Eric: "Working on ______ almost done"',
    'Eric: Typing noises',
    'Jeff: "Fuck.*"',
    'Jeff: Built-in mic instead of headset',
    'Jeff: Denies using wrong mic',
    'Jeff: interrupting',
    'Jeff: "bogus"',
    'Jeff: "Red Herring"',
    'Jeff: Weekend feature / refactoring',
    'Jeff: ".*shit"',
    'Jeff: "stupid"',
    'Jeff: Raise voice / yelling',
    'Joy: Needs to drop out',
    'Joy: Late to the meeting',
    'Joy: Calling from a car',
    'Joy: Calling from a gym',
    'Keith: Creepy laugh',
    'Keith: Unfunny joke',
    'Meeting: 5+ min late',
    'Meeting: Longer than 75 min',
    'Ravi: unfunny joke',
    'Ray: Chirping bird',
    'Ray: "mute button"',
    'Ray: Sneeze / Cough into hot mic',
    'Ryan: ninjato',
    'Ryan: "a-BOOT"',
    'Someone breathing into mic',
    'Someone coughing into mic',
